	...
	<div class="container">
		<div class="card mx-auto"  style="width: 18rem">
		  ...
		  <div class="card-body">
		    ...
		    <form id="edit_profile" onsubmit="return false" autocomplte="off">
			  ...
			  <button type="submit" name="user_register" class="btn btn-primary"><i class="fa fa-lock">&nbsp;</i>Edit Profile</button>
			</form>
		   </div>
